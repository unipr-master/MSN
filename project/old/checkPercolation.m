function [tbPercolates, lrPercolates] = checkPercolation(labels)
% CHECKPERCOLATION Checks if there's percolation top-to-bottom (tb) 
% and left-to-right (lr).
%
%   [tbPercolates, lrPercolates] = checkPercolation(labels)
